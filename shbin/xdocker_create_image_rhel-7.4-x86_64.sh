...
IMAGE_FILENAME="${MY_NAME}rhel-7.4-x86_64${VERSION}.xdockerimage"
...
cp /bin/xdockerinit ${IMAGE_RLAYER_PATH_BASE}/bin/
cp /lib64/libxdocker_util.so ${IMAGE_RLAYER_PATH_BASE}/lib64/
