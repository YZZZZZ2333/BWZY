...
static int CloneEntry( void *pv )
{
	...
	if( env->cgroup_enable )
	{
		if( env->cmd_para.__cpus )
		{
			...
			nret = WriteFileLine( env->cmd_para.__cpus , cgroup_cpuset_cpus_file , sizeof(cgroup_cpuset_cpus_file) , "%s/cpuset/xdocker_%s/cpuset.cpus" , CGROUP_PATH , env->cmd_para.__container ) ;
			INTER1( "*** ERROR : WriteFileLine cpuset.cpus failed[%d] , errno[%d]\n" , nret , errno )
			EIDTI( "write file %s ok\n" , cgroup_cpuset_cpus_file )
			
			nret = WriteFileLine( env->cmd_para.__cpus , cgroup_cpuset_mems_file , sizeof(cgroup_cpuset_mems_file) , "%s/cpuset/xdocker_%s/cpuset.mems" , CGROUP_PATH , env->cmd_para.__container ) ;
			INTER1( "*** ERROR : WriteFileLine cpuset.mems failed[%d] , errno[%d]\n" , nret , errno )
			EIDTI( "write file %s ok\n" , cgroup_cpuset_mems_file )
			
			nret = WriteFileLine( pid_str , cgroup_cpuset_tasks_file , sizeof(cgroup_cpuset_tasks_file) , "%s/cpuset/xdocker_%s/tasks" , CGROUP_PATH , env->cmd_para.__container ) ;
		...
		if( env->cmd_para.__cpu_quota )
		{
			...
			nret = WriteFileLine( "1000000" , cgroup_cpu_cfs_period_us_file , sizeof(cgroup_cpu_cfs_period_us_file) , "%s/cpu,cpuacct/xdocker_%s/cpu.cfs_period_us" , CGROUP_PATH , env->cmd_para.__container ) ;
			...
			nret = WriteFileLine( pid_str , cgroup_cpu_tasks_file , sizeof(cgroup_cpu_tasks_file) , "%s/cpu,cpuacct/xdocker_%s/tasks" , CGROUP_PATH , env->cmd_para.__container ) ;
		...
		if( env->cmd_para.__mem_limit )
		{
			...
			nret = WriteFileLine( env->cmd_para.__mem_limit , cgroup_memory_limit_in_bytes_file , sizeof(cgroup_memory_limit_in_bytes_file) , "%s/memory/xdocker_%s/memory.limit_in_bytes" , CGROUP_PATH , env->cmd_para.__container ) ;
			INTER1( "*** ERROR : WriteFileLine memory.limit_in_bytes failed[%d] , errno[%d]\n" , nret , errno )
			EIDTI( "write file %s ok\n" , cgroup_memory_limit_in_bytes_file )
			
			nret = WriteFileLine( env->cmd_para.__mem_limit , cgroup_memory_memsw_limit_in_bytes_file , sizeof(cgroup_memory_memsw_limit_in_bytes_file) , "%s/memory/xdocker_%s/memory.memsw.limit_in_bytes" , CGROUP_PATH , env->cmd_para.__container ) ;
			INTER1( "*** ERROR : WriteFileLine memory.memsw.limit_in_bytes failed[%d] , errno[%d]\n" , nret , errno )
			EIDTI( "write file %s ok\n" , cgroup_memory_memsw_limit_in_bytes_file )
			
			nret = WriteFileLine( pid_str , cgroup_memory_tasks_file , sizeof(cgroup_memory_tasks_file) , "%s/memory/xdocker_%s/tasks" , CGROUP_PATH , env->cmd_para.__container ) ;
